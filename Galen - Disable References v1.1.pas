{
  Galen: Disable references, almost the copy of internal
  xEdit code.
  Does not require applied filter.
  2015-03-09  Version 1.0   modified Undelete and Diable References.pas
    removed check for 'deleted'
    do NOT move item to -3000 Z; keep Z
    don't print count of skipped navmeshes
  2015-03-15 Debugged and working
}
unit UserScript;
